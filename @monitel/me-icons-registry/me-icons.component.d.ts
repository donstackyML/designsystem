...
export declare class MeIconComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MeIconComponent, "me-icon", never, { "color": { "alias": "color"; "required": false; }; "name": { "alias": "name"; "required": false; }; "size": { "alias": "size"; "required": false; }; "containerSize": { "alias": "containerSize"; "required": false; }; }, {}, never, ["*"], false, never>;
