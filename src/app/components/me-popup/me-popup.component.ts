...
export class MePopupComponent {
  ...
  lorem25 =
    'Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam corporis doloremque quia sed reprehenderit corrupti ea quae. Ab, at. Excepturi similique accusamus nihil autem eligendi?';
  arrowBackIcon = `<svg width="iconSize" height="iconSize" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
