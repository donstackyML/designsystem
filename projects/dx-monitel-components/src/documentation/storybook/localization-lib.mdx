...
#### 1. Добавить файл autolocale.json в библиотеку, например, ./lib/assets/i18n/autolocale.json
...
export class LocalizationService {
  ...
  constructor() {
    try {
      const data = this.loadJSON('assets/{название вашего приложения}/i18n/autolocale.json');
