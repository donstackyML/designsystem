...
#### 1. Добавить файл auto-local.json в библиотеку, например, ./lib/assets/i18n/auto-local.json
...
export class LocalizationService {
  ...
  constructor() {
    try {
      const data = this.loadJSON('assets/{название вашего приложения}/i18n/auto-local.json');
