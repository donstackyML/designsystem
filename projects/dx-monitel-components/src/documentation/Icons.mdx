...
<Source
  code={`npm install @monitel/me-icon
...
<Source
  ...
  ...
  this.add_24 = this.iconRegistry.getIcon('24_add', 'var(--Icon-Error)');
}`}
  language="js"
  dark
/>
...
<Source
  code={`constructor(private meIconRegistry: MeIconsRegistry) {
  ...
  this.add_24 = this.iconRegistry.getIcon('24_add', 'var(--Icon-Cyan-Position)');
}`}
  language="js"
  dark
/>
