...
const chipsContainerMeta: Meta<MeChipsContainerComponent> = {
  ...
  argTypes: {
    ...
    multiSelect: {
      control: 'boolean',
      description: 'Режим множественного выбора чипов. При true позволяет выбирать несколько чипов одновременно.',
      table: {
    ...
    chipsChange: {
      action: 'chipsChange',
      description: 'Событие, возникающее при изменении массива чипов (удаление)',
      table: {
        category: 'Events',
...
export const Default: ChipsContainerStory = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Базовый пример использования компонента с чипами среднего размера.',
      },
    },
  },
};
...
export const SingleChip: ChipsContainerStory = {
  ...ChipsContainerTemplate,
  args: {
    chips: [{ label: 'Одиночный чип', size: 'medium', count: 1, selected: false }],
    multiSelect: false,
  },
  parameters: {
    docs: {
...
export const DisabledChips: ChipsContainerStory = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Пример отключенных чипов. Они не могут быть выбраны или удалены.',
      },
    },
  },
};
...
export const ManyChips: ChipsContainerStory = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Пример с большим количеством чипов для демонстрации поведения контейнера.',
      },
    },
  },
};
...
export const MultiSelect: ChipsContainerStory = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Режим множественного выбора чипов. Позволяет выбирать несколько чипов одновременно.',
      },
    },
  },
};
