...
- [ширина и высота в зависимости от size](#ширина-и-высота-окна-в-зависимости-от-свойства-size)
...
Так же при использовании одного попапа можно использовать instance.show()
