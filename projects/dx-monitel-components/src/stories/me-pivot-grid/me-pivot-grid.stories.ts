...
export default {
  ...
  argTypes: {
    ...
    allowFiltering: {
      control: 'boolean',
      description:
        'Позволяет пользователю фильтровать поля, выбирая или отменяя выбор значений во всплывающем меню.',
    },
    showColumnGrandTotals: {
      control: 'boolean',
      description: 'Указывает, следует ли отображать столбец Общего итога.',
    },
    showRowGrandTotals: {
      control: 'boolean',
      description: 'Указывает, следует ли отображать строку Общего итога.',
    },
    showRowTotals: {
      control: 'boolean',
      description: 'Указывает, следует ли отображать строку Итогов.',
    },
    showColumnTotals: {
      control: 'boolean',
      description: 'Указывает, следует ли отображать столбец Итогов.',
    },
  },
  args: {
    dataSource: {
...
export const PivotGrid: StoryObj = {};
