...
цвета и размеры в соответствие с дизайн-системой.
...
[API](https://js.devexpress.com/Angular/Documentation/ApiReference/UI_Components/dxList/)

[Демо](https://js.devexpress.com/Angular/Demos/WidgetsGallery/Demo/List/ListEditingAndAPI/Light/)
...
Не забудьте указать свойство <code>[grouped]="true"</code>. Для сворачивающего списка нужно установить свойство <code>collapsibleGroups</code> в <code>true</code>.
...
<Canvas of={listStories.HeaderDescription} />
...
<Canvas of={listStories.ListDescription} />
...
<Canvas of={listStories.MoreContent} />
